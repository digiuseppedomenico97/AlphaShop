...
public class ArticoliController 
{
	...
	private BigDecimal getPromoArt(String CodArt, String Header){
		BigDecimal prezzo = promoClient.getPromoArt(CodArt, Header);
		logger.info("Prezzo articolo"+ CodArt + ":", prezzo);
		return prezzo;
	}
	...
	@GetMapping(value = "/noauth/cerca/codice/{codart}")
	public ResponseEntity<Articoli>  getArticolo(@PathVariable("codart") String CodArt)
			throws NotFoundException
{
			...
			throws NotFoundException	
	{
		...
		String AuthHeaders = HttpRequest.getHeader("Authorization");
		...
		else
		{
			...
			articolo.setPrezzo(this.getPriceArt(articolo.getCodArt(),"", AuthHeaders));
		}
	...
	private BigDecimal getPriceArt (String CodArt, String IdList, String Header){
		BigDecimal Prezzo = (IdList.length() > 0) ?
